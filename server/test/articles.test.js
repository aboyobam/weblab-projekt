...
describe("Should test the articles API", () => {
    const module = "TEST";
    ...
    it("Should create a article over the API", async () => {
    ...
    it("Should be visible when loading all articles", async () => {
        const res = await express.get("/api/articles");
