...
describe("Should test the Module description API", () => {
    const module = "TEST";
    ...
    it("Should create a module description over the API", async () => {
    ...
    it("Should be visible when loading all module descriptions", async () => {
        const res = await express.get("/api/modules");
